...
@Composable
 fun ColorPickerBottomShitContent(
    colors: List<Int>,
    ...
    Column(
        ...
        Text(
            ...
            text = stringResource(id = R.string.create_task_color_picker_dialog_title_text),
            ...
            content = {
                items(colors) { color ->
                    Spacer(modifier = Modifier
                        ...
                        .background(color = Color(color), RoundedCornerShape(18.dp))
                        .clickable { actioner(CreateTaskAction.ChoseColor(color)) })
                }
            })
    }
}
